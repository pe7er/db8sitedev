 ...
 * @since  1.6
 */
class Db8sitedevModelChecks extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$checked = $app->getUserStateFromRequest($this->context . '.filter.checked', 'filter_checked', '', 'string');
		...
		$this->setState('filter.category_id', $checked);
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__db8sitedev_checks` AS a');
		...
		$checked = $this->getState('filter.checked');

		if (is_numeric($checked))
		{
			$query->where('a.checked = ' . (int) $checked);
		}
