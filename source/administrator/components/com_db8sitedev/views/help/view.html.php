 ...
 * @since  1.6
 */
class Db8sitedevViewHelp extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Db8sitedevHelpersDb8sitedev::addSubmenu('help');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_DB8SITEDEV') . ": " . JText::_('COM_DB8SITEDEV_TITLE_HELP'), 'info.png');
